...
!function () {
  ...
  var bars = {
    bartab             : '.cl-content',
    bartab2            : '.cl-bar-title',
    bartab2            : '.cl-bar-footer',
    bartab3            : '.cl-docs-content'
  };
  ...
  var popstate = function (e) {
    ...
    if (transitionFromObj.transition) {
      activeObj = extendWithDom(activeObj, '.cl-content', activeDom.cloneNode(true));
      for (key in bars) {
    ...
    swapContent(
      ...
      document.querySelector('.cl-content'),
      transition
    );
  ...
  var PUSH = function (options) {
    ...
    options.container = options.container || options.transition ? document.querySelector('.cl-content') : document.body;
  ...
  var swapContent = function (swap, container, transition, complete) {
    ...
    if (!transition) {
      ...
      else if (swap.classList.contains('cl-content')) document.body.appendChild(swap);
      else document.body.insertBefore(swap, document.querySelector('.cl-content'));
    } else {
  ...
  var triggerStateChange = function () {
    ...
    // Custom
    $('.animate-inactive').removeClass('animate-inactive').addClass('animate-active');
  };
  ...
  var parseXHR = function (xhr, options) {
    ...
    if (options.transition) data = extendWithDom(data, '.cl-content', body);
