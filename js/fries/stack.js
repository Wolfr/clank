!function(){
  ...
  var handlePopState = function (e) {
    ...
    replaceContents(
      (activeObj.contents || activeDom.querySelector('.cl-page')).cloneNode(true),
  ...
  var parseXHR = function (xhr, options) {
    ...
    data.contents = body.querySelector('.cl-page');

    // Get the docs contents of the page
    data.contents2 = body.querySelector('.cl-docs-content');
