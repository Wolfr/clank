...
<div class="cl-page cl-page-table-view">
  ...
  <div class="cl-content">
    <h3 class="cl-table-view-title">Regular table view</h3>
    ...
    <h3 class="cl-table-view-title">Regular table view with disclosure arrows</h3>
    <div class="cl-table-view">
      <div class="cl-table-view__cell-single">
        <a href="#">
          <span class="label">Item 1</span>
    ...
    <h3 class="cl-table-view-title">Regular table view with disclosure arrows and help text near disclosure</h3>
    <div class="cl-table-view">
      <div class="cl-table-view__cell-single">
        <a href="#">
          <i class="icon icon-ios-arrow-right"></i>
    ...
    <h3 class="cl-table-view-title">Regular table view with icons in front of labels</h3>
    <div class="cl-table-view">
      <div class="cl-table-view__cell-single">
        <a href="#">
    ...
    <h3 class="cl-table-view-title-extended">Extended table view</h3>
